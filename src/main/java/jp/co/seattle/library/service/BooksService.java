...
public class BooksService {
	...
	public BookDetailsInfo getBookInfo(int bookId) {
		...
		// JSPに渡すデータを設定する
		String sql = "SELECT * ,CASE WHEN bookid isnull THEN '貸し出し可' ELSE '貸し出し中' END AS status FROM books LEFT OUTER JOIN rent ON books.id = rent.bookid where bookid ="+ bookId;
